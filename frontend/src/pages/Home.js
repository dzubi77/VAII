...
function HomePageRight() {
    return (
        <div className="homepage-right">
            ...
            <p>
                Click <a href="/courses" className="btn btn-primary">here</a> to start your first course or 
                <a href="/login" className="btn btn-primary">log in</a> to continue learning.
            </p>
        </div>
    );
}
